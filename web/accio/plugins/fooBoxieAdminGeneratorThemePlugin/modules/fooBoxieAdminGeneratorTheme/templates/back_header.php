...
<?php if ($sf_user->isAuthenticated()): ?> 
  <div id='sf_admin_theme_header'>
    <a href='<?php echo url_for('homepage') ?>'><?php echo image_tag(fooBoxieAdminGeneratorTheme::getProperty('web_dir').'/images/header_text', array('alt' => 'Home')); ?></a>
  </div>
  ...
  <div id='sf_admin_menu'>    
    ...
    <?php if (fooBoxieAdminGeneratorTheme::getProperty('logout') && $sf_user->isAuthenticated()): ?>
      <div id="logout"><?php echo link_to(__('Logout', null, 'sf_admin_dash'), fooBoxieAdminGeneratorTheme::getProperty('logout_route', '@sf_guard_signout ')); ?> <?php echo $sf_user; ?></div>
    <?php endif; ?>
    <div class="clear"></div>
  </div>

  <?php if (fooBoxieAdminGeneratorTheme::getProperty('include_path')): ?>
    <div id='sf_admin_path'>
      <strong><a href='<?php echo url_for('homepage'); ?>'><?php echo fooBoxieAdminGeneratorTheme::getProperty('site'); ?></a></strong>

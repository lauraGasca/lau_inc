...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
  <head>
    ...
    <!--[if lte IE 7.0]><link rel="stylesheet" type="text/css" href="/fooBoxieAdminGeneratorThemePlugin/css/boxie/ie.css" media="screen, projection, tv" /><![endif]-->
    <!--[if IE 8.0]>
            <style type="text/css">
    ...
    <!--[if lte IE 6]>
            <script type="text/javascript" src="/fooBoxieAdminGeneratorThemePlugin/js/ddpng.js"></script>
      ...
      <div class="inner-container clearfix">
        ...
        <form action="" method="post"><!-- Search form -->
          <fieldset>
            ...
            <input class="hand fr" type="image" src="/fooBoxieAdminGeneratorThemePlugin/css/boxie/img/search-button.png" alt="Search" />
          </fieldset>
        </form>
      </div><!-- .inner-container -->
    </div><!-- #nav -->

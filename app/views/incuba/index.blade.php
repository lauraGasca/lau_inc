...
<section id="nosotros" class="page">
    <section class="section bg-gray-color">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <hgroup class="section-title align-center opacity">
                        ...
                        <h2>&quot;El &eacute;xito no es la clave de la felicidad. La felicidad es la clave del &eacute;xito. Si amas lo que haces, tendr&aacute;s &eacute;xito&quot;</h2>	
                    </hgroup>			
                </div>
            </div><!--/ .row-->
        </div><!--/ .container-->	
                                ...
                                <div class="contents clearfix">
                                    <div class="work-item">
                                        <div class="team-image">
                                            <a href="mailto:nvidal@incubamas.com"><img src="{{ URL::asset('accio/images/equipo/2014-09-01 18.02.00.jpg')}}" alt="" /></a>
                                        </div>
                                        <a  href="mailto:nvidal@incubamas.com">
                                            <div class="image-extra">
                                                <div class="extra-content">
                                                    <div class="inner-extra">
                                    ...
                                    <hgroup class="team-group">
                                        <h2 class="team-title">No&eacute; Vidal</h2>
                                        <h5 class="team-position">Director General</h5>
                                    </hgroup>
                                </div><!--/ .entry-image-->
                            </article><!--/ .entry-->
                            <article class="scale">
                                <div class="contents clearfix">
                                    <div class="work-item">
                                        <div class="team-image">
                                            <a href="#"><img src="{{ URL::asset('accio/images/equipo/2014-09-03 18.18.50.jpg')}}" alt="" /></a>
                                        </div>
                                        <a  href="mailto:yruiz@incubamas.com">
                                            <div class="image-extra">
                                                <div class="extra-content">
                                                    <div class="inner-extra">
                                    ...
                                    <hgroup class="team-group">
                                        <h2 class="team-title">Yosselyn Ruiz</h2>
                                        <h5 class="team-position">Gerente de Proyectos Estrat&eacute;gicos y Desarrollo</h5>
                                    </hgroup>
                                </div><!--/ .entry-image-->
                            </article><!--/ .entry-->
                            <article class="scale">
                                <div class="contents clearfix">
                                    <div class="work-item">
                                        <div class="team-image">
                                            <a href="#"><img src="{{ URL::asset('accio/images/equipo/10668340_10203937245984875_298917041_n.jpg')}}" alt="" /></a>
                                        </div>
                                        <a  href="mailto:bmedina@incubamas.com">
                                            <div class="image-extra">
                                                <div class="extra-content">
                                                    <div class="inner-extra">
                                    ...
                                    <hgroup class="team-group">
                                        <h2 class="team-title">Brenda Medina</h2>
                                        <h5 class="team-position">Comunicaci&oacute;n y RR.PP</h5>
                                    </hgroup>
                                </div><!--/ .entry-image-->
                            </article><!--/ .entry-->
                            <article class="scale">
                                <div class="contents clearfix">
                                    <div class="work-item">
                                        <div class="team-image">
                                            <a  href="#"><img src="{{ URL::asset('accio/images/equipo/2014-09-01 18.40.41.jpg')}}" alt="" /></a>
                                        </div>
                                        <a  href="mailto:dgrafico@incubamas.com">
                                            <div class="image-extra">
                                                <div class="extra-content">
                                                    <div class="inner-extra">
                                    ...
                                    <hgroup class="team-group">
                                        <h2 class="team-title">Francisco Ch&aacute;vez</h2>
                                        <h5 class="team-position">Dise&ntilde;o Editorial Digital y Creativo</h5>
                                    </hgroup>
                                </div><!--/ .entry-image-->
                            </article><!--/ .entry-->
                        </div>
                        ...
                        <div class="team-contents clearfix">
                            <article class="scale">
                                <div class="contents clearfix">
                                    <div class="work-item">
                                        <div class="team-image">
                                            <a  href="#"><img src="{{ URL::asset('accio/images/equipo/2014-09-01 18.10.50.jpg')}}" alt="" /></a>
                                        </div>
                                        <a  href="mailto:lgasca@incubamas.com">
                                            <div class="image-extra">
                                                <div class="extra-content">
                                                    <div class="inner-extra">
                                    ...
                                    <hgroup class="team-group">
                                        <h2 class="team-title">Laura Gasca </h2>
                                        <h5 class="team-position">Desarrollador Web</h5>
                                    </hgroup>
                                </div><!--/ .entry-image-->
                            </article><!--/ .entry-->
                            <article class="scale">
                                <div class="contents clearfix">
                                    <div class="work-item">
                                        <div class="team-image">
                                            <a  href="#"><img src="{{ URL::asset('accio/images/equipo/2014-09-01 18.08.08.jpg')}}" alt="" /></a>
                                        </div>
                                        <a  href="mailto:hola@incubamas.com">
                                            <div class="image-extra">
                                                <div class="extra-content">
                                                    <div class="inner-extra">
                                    ...
                                    <hgroup class="team-group">
                                        <h2 class="team-title">Mariela Morales</h2>
                                        <h5 class="team-position">Atenci&oacute;n a Emprendedores </h5>
                                    </hgroup>
                                </div><!--/ .entry-image-->
                            </article><!--/ .entry-->
                            <article class="scale">
                                <div class="contents clearfix">
                                    <div class="work-item">
                                        <div class="team-image">
                                            <a  href="#"><img src="{{ URL::asset('accio/images/equipo/2014-09-01 18.04.10.jpg')}}" alt="" /></a>
                                        </div>
                                        <a  href="mailto:dgrafico@incubamas.com">
                                            <div class="image-extra">
                                                <div class="extra-content">
                                    ...
                                    <hgroup class="team-group">
                                        <h2 class="team-title">Omar Bautista</h2>
                                        <h5 class="team-position">Dise&ntilde;o Grafico</h5>
                                    </hgroup>
                                </div><!--/ .entry-image-->
                            </article><!--/ .entry-->
                            <article class="scale">
                                <div class="contents clearfix">
                                    <div class="work-item">
                                        <div class="team-image">
                                            <a  href="mailto:contabilidad@incubamas.com"><img src="{{ URL::asset('accio/images/equipo/2014-09-01 18.19.19.jpg')}}" alt="" /></a>
                                        </div>
                                        <a  href="mailto:contabilidad@incubamas.com">
                                            <div class="image-extra">
                                                <div class="extra-content">
                                                    <div class="inner-extra">
                                    ...
                                    <hgroup class="team-group">
                                        <h2 class="team-title">Jazm&iacute;n G&oacute;mez</h2>
                                        <h5 class="team-position">Analista Financiero y Gesti&oacute;n de Proyectos</h5>
                                    </hgroup>
                                </div><!--/ .entry-image-->
                            </article><!--/ .entry-->				
                        </div><!--/ .team-contents-->
                        ...
                        <div class="team-contents clearfix">
                            <article class="scale">
                                <div class="contents clearfix">
                                    <div class="team-info">
                                        <div class="team-image">
                                            <a  href="mailto:nvidal@incubamas.com"><img src="{{ URL::asset('accio/images/equipo/2014-09-01 18.25.01.jpg')}}" alt="" /></a>
                                        </div>
                                        <hgroup class="team-group">
                                            <h2 class="team-title">Cyndi Corona</h2>
                                            <h5 class="team-position">Asesor Legal</h5>
                                        </hgroup>
                                    </div><!--/ .team-info-->				
                                </div><!--/ .contents-->
                            </article>

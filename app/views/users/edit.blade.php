...
@section('contenido')
    ...
    <div class="powerwidget col-grey" id="user-directory" data-widget-editbutton="false">
        <div class="inner-spacer">
            {{ Form::model($usuario, ['url'=>'usuarios/editar-user', 'class'=>'orb-form','method' => 'post', 'enctype'=>'multipart/form-data'])}}
                {{Form::hidden('id')}}
                <fieldset>
                    ...
                    <div class="col-md-6 espacio_abajo">
                        ...
                        <script type="text/javascript">
                            $("#foto").fileinput({
                                ...
                                initialPreview: [
                                    "<img src='{{url('Orb/images/emprendedores/'.$usuario->foto)}}' class='file-preview-image'>"
                                ],

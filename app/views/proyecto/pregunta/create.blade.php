...
@section('mapa')
    ...
    <li><a href="{{url('plan-negocios/modulo/'.$modulo->id)}}">{{$modulo->nombre}}</a></li>
    <li class="active">Crear</li>
@stop

@section('titulo-seccion')
    <h1>Pregunta<small>Crear</small></h1>
@stop
...
@section('contenido')
    ...
    <div class="powerwidget col-grey" id="user-directory" data-widget-editbutton="false">
        <div class="inner-spacer">
            {{Form::open(['url'=>'plan-negocios/crear-pregunta', 'class'=>'orb-form','method' => 'post', 'enctype'=>'multipart/form-data'])}}
                ...
                <fieldset>
                    ...
                    <div class="col-md-6 espacio_abajo">
                        ...
                        <label class="input">
                            {{Form::text('orden', count($modulo->preguntas)+1)}}
                        </label>
                    </div>

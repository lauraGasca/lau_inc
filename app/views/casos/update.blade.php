...
@section('contenido')
    ...
    <div class="powerwidget col-grey" id="user-directory" data-widget-editbutton="false">
        <div class="inner-spacer">
            {{ Form::model($caso, ['url'=>'casos/editar', 'class'=>'orb-form','method' => 'post', 'enctype'=>'multipart/form-data'])}}
                {{Form::hidden('id')}}
                <fieldset>
                    ...
                    <div class="col-md-5 espacio_abajo">
                        ...
                        {{Form::text('servicios', $relaciones, ['style'=>'visibility: hidden', 'id'=>'serv_tags']) }}
                        <ul id="tags"></ul>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $("#imagen").fileinput({
            ...
            initialPreview: [
                "<img src='{{url('Orb/images/casos_exito/'.$caso->imagen)}}' class='file-preview-image'>"
            ],

          ...
          <ul id="myTab" class="nav nav-tabs nav-justified">
              <li
                @if(!isset($active_chat))
                  class="active"
                @endif
              ><a href="#emprendedor" data-toggle="tab">Emprendedor</a></li>
              ...
              @if(Auth::user()->type_id==3)
                <li
                  @if(isset($active_chat))
                    class="active"
                  @endif
                ><a href="#mensajeria" data-toggle="tab">Mensajeria</a></li>
              @endif
                          ...
                          <ul id="ul_chats">
                            ...
                            @if(count($chats) > 0)
                              @foreach($chats as $chat)
                                ...
                                <li>
                                  <a href="{{url('emprendedores/perfil/'.$emprendedor[0]->id.'/'.$var_chat.'/'.$var_user.'/'.$chat->grupo.'/'.$chat->nombre.'#mensajeria')}}">
